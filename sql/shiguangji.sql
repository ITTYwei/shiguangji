CREATE TABLE `t_user` (
                          ...
                          `shiguangji_id` varchar(15) NOT NULL COMMENT '小哈书号(唯一凭证)',
                          ...
                          UNIQUE KEY `uk_shiguangji_id` (`shiguangji_id`),
...
INSERT INTO `shiguangji`.`t_permission` (`id`, `parent_id`, `name`, `type`, `menu_url`, `menu_icon`, `sort`,
...
INSERT INTO `shiguangji`.`t_role` (`id`, `role_name`, `role_key`, `status`, `sort`, `remark`, `create_time`,
                                   `update_time`, `is_deleted`)
VALUES (1, '普通用户', 'common_user', 0, 1, '', now(), now(), b'0');

INSERT INTO `shiguangji`.`t_role_permission_rel` (`id`, `role_id`, `permission_id`, `create_time`, `update_time`,
                                                  `is_deleted`)
