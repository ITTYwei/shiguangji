...
import com.xiaowei.framework.common.exception.BaseExceptionInterface;
...
public enum ResponseCodeEnum implements BaseExceptionInterface {
    ...
    SHIGUANGJI_ID_VALID_FAIL("USER-20002", "拾光集号请设置6-15个字符，仅可使用英文（必须）、数字、下划线"),
    ...
    USER_ROLE_NOT_FOUND("USER-20008", "该用户角色不存在"),
    ;
